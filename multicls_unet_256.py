...
for directory_path in glob.glob("128_patches/sar_256/train"):
...
train_masks = [] 
for directory_path in glob.glob("128_patches/zones_processed_256/train"):
...
large_image = cv2.imread('data_raw/data_raw/sar_images/test/COL_2011-06-18_TDX_7_1_024.png', 0)
