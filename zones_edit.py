            ...
            with Image.open(os.path.join(input_folder, filename)) as img:
                ...
                for y in range(height):
                    for x in range(width):
                        ...
                        if pixel_value < 40:
                            img_array[x, y] = 1
                        elif pixel_value >= 40 and pixel_value<100:
                            img_array[x,y] = 2
                        elif pixel_value >= 100 and pixel_value < 160:
                            img_array[x, y] = 3
...
if __name__ == "__main__":
    ...
    input_folder = "data_raw/data_raw/zones/train"
    output_folder = "128_patches/zones_processed_256/train"
